...
/*   Updated: 2020/12/01 09:11:21 by shikma           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	trans_cy_sq_li(t_vector tr, t_cam_elm **c_ptr, t_element **ptr)
{
	...
	if ((*ptr) && (*ptr)->ptr_last && (*ptr)->ptr_last->id == 4)
	{
...
void	translate(char **str, t_cam_elm **c_ptr, t_element **ptr)
{
